...
CREATE TABLE MC_ALIQUOTA_MEDIA_ICMS_ESTADO (
    ...
    CONSTRAINT PK_MC_ALIQUOTA_MEDIA_ICMS_ESTADO PRIMARY KEY (SG_ESTADO)
);

-- Adicionar comentários para as colunas
COMMENT ON COLUMN MC_ALIQUOTA_MEDIA_ICMS_ESTADO.SG_ESTADO IS 'Esta coluna irá receber a sigla do estado.';
COMMENT ON COLUMN MC_ALIQUOTA_MEDIA_ICMS_ESTADO.VL_PERC_ALIQUOTA_MEDIA IS 'Esta coluna irá receber a alíquota média do estado.';

-- Inserir dados na tabela
INSERT INTO MC_ALIQUOTA_MEDIA_ICMS_ESTADO (SG_ESTADO, VL_PERC_ALIQUOTA_MEDIA) VALUES ('AC', 17);
-- Continue inserindo os dados para outros estados

-- Criar a função
CREATE OR REPLACE FUNCTION fun_mc_gera_aliquota_media_icms_estado(p_sg_estado IN VARCHAR2) RETURN NUMBER IS
